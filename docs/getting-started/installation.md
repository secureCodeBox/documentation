...
The secureCodeBox supports the 4 latest Kubernetes releases (`v1.23`, `v1.22`, `v1.21` & `v1.20`). Older version might also work but are not officially supported or tested.
