...
One powerful feature of the secureCodeBox is the dynamic scan orchestration of different security scanner: the [cascading scans mechanism](https://docs.securecodebox.io/docs/hooks/cascading-scans).
